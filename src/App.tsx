...
const App: React.FC = () => {
  ...
  const getThemeBackground = () => {
    switch(appTheme) {
      case 'neon':
        return 'bg-gradient-to-b from-indigo-900 via-purple-800 to-pink-700';
      case 'elegance':
        return 'bg-gradient-to-b from-gray-900 via-gray-800 to-gray-700';
      case 'modern':
        return 'bg-gradient-to-b from-teal-900 via-slate-800 to-slate-700';
      default:
        return 'bg-gradient-to-b from-indigo-900 via-purple-800 to-pink-700';
    }
  };
  ...
  return (
    <ThemeProvider initialTheme={appTheme} initialSpeed={appAnimSpeed}>
      <div className={`min-h-screen flex flex-col transition-colors duration-500 overflow-x-hidden ${getThemeBackground()}`}>
        {/* Sticky header */}
        <header className="sticky top-0 z-50 w-full bg-gradient-to-r from-indigo-900 to-gray-900 shadow-md">
        ...
        <main className="flex-grow flex flex-col items-center justify-center p-4 md:p-8 relative z-10 overflow-y-auto">
          {renderContent()}
        </main>
        ...
        {/* Footer */}
        <footer className="py-4 text-center text-white/90 text-sm relative z-10 flex flex-col items-center">
          <div className="mb-2">
